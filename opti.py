...
PLOTS_DIR = "Documents/CoursCYTech/ING3/Opti-Metaheuristique/Projet Opti/plots"
...
def save_plot(figure, title, pareto_front=pareto_front, directory=PLOTS_DIR):
...
pf = pareto_front()
save_plot(scatter_uniform, "Das-Dennis", pf)
...
pf = pareto_front()
save_plot(scatter_multi_layer, "Multi-layer Approach", pf)
...
pf = pareto_front()
save_plot(scatter_layer_energy, "LayerwiseRieszEnergyReferenceDirectionFactory", pf)
